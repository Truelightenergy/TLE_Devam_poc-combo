...
class PricingDesk:
    ...
    def price_desk(self, ):
        ...
        query_strings["curvestart"] = self.curve_date(query_strings["iso"], query_strings["operating_day_end"], "loadprofile")
        loadprofile, status = self.loadprofile.extraction(query_strings)
        query_strings["curve_type"] = "shaping"
        query_strings["curvestart"] = self.curve_date(query_strings["iso"], query_strings["operating_day_end"], "shaping")
        shaping, status = self.shaping.extraction(query_strings)
        query_strings["curve_type"] = "vlr"
        query_strings["curvestart"] = self.curve_date(query_strings["iso"], query_strings["operating_day_end"], "vlr")
        vlr, status = self.vlr.extraction(query_strings)
        query_strings["curve_type"] = "lineloss"
        query_strings["curvestart"] = self.curve_date(query_strings["iso"], query_strings["operating_day_end"], "lineloss")
