    ...
    populateNotifications: function () {
        ...
        for (var i = 0; i < window.notification_data.length; i++) {
            ...
            if (location.length <= 2) {
                ...
                var marqueItem = `Prompt month energy in <font style="color:#005A9A;">${location[0]}</font>, ${location[1].split('(')[0]} <font style="color:#005A9A;">${location[1].split('(')[1].replace(')', '')}</font>`;
