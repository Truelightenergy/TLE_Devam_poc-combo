...
class Ercot_Rec:
    ...
    def renaming_columns(self, df):
        ...
        df = df.rename(columns={'TX_EY': 'month', 
            'TX_Total_Cost_per_MWh' : 'tx_total_cost_per_mWh',
            'TX_Compliance' : 'tx_compliance' ,
            'TX_REC Price' : 'tx_rec_price',
            'TX_nan' : 'tx_year',
            'TX_Total_Texas_Competitive_Load_MWh' : 'tx_total_texas_competitive_load_mWh',
            'TX_RPS_Mandate_MWh' : 'tx_rps_mandate_mWh',
            'TX_prct' : 'tx_prct'} )
