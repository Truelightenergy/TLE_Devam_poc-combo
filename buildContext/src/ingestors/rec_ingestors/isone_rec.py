...
from .helpers.isone_rec_helper import IsoneRecHelper
                    ...
                    backup_query = f'''
                        ...
                        -- insertion to the database in history table
                            ...
                            backup as (
                                ...
                                insert into trueprice.{data.controlArea}_rec_history (month, curvestart, curveend, data, control_area, state, load_zone, capacity_zone, utility, strip, cost_group, cost_component, sub_cost_component)
                        ...
                        -- update the existing "current" with the new "csv"
                            ...
                            deletion as(
                            DELETE from trueprice.{data.controlArea}_rec
                            WHERE curvestart = (select curvestart from single)

                            ),

                            updation as (
                            insert into trueprice.{data.controlArea}_rec (month, curvestart, data, control_area, state, load_zone, capacity_zone, utility, strip, cost_group, cost_component, sub_cost_component)
                        ...
                        select * from trueprice.{data.controlArea}_rec;
