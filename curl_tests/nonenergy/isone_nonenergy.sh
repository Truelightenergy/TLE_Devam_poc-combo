...
# upload 1
if ! upload_check "buildContext/good_test_data/nonenergy/NonEnergy_ISONE_20230327_101010.csv"; then
...
if ! upload_check "buildContext/good_test_data/nonenergy/NonEnergy_ISONE_20230327_101011.csv"; then
