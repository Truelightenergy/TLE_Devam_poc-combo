...
# upload 1
if ! upload_check "buildContext/good_test_data/nonenergy/NonEnergy_PJM_20230410_101010.csv"; then
...
if ! upload_check "buildContext/good_test_data/nonenergy/NonEnergy_PJM_20230410_101011.csv"; then
