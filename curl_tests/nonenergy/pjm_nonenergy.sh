...
truncate_nonenergy "pjm"

# upload 1
if ! upload_check "/home/alee/Documents/truelight/poc-combo/buildContext/good_test_data/nonenergy/NonEnergy_PJM_20230410_101010.csv"; then
  printf "error upload_check"
fi

# check existance via psql
if ! psql_check "pjm"; then
  printf "error psql_check"
fi

# check existance via api
if ! api_check "pjm"; then
  printf "error api_check"
fi

if ! upload_check "/home/alee/Documents/truelight/poc-combo/buildContext/good_test_data/nonenergy/NonEnergy_PJM_20230410_101011.csv"; then
...
if ! psql_history_check "pjm"; then
