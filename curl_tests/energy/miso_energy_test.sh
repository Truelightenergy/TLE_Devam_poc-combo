...
truncate_energy "miso"

# upload 1
if ! upload_check "/home/alee/Documents/truelight/poc-combo/buildContext/good_test_data/energy/Energy_MISO_20230522_082540.csv"; then
...
if ! upload_check "/home/alee/Documents/truelight/poc-combo/buildContext/good_test_data/energy/Energy_MISO_20230522_082541.csv"; then
