...
# upload 1
if ! upload_check "buildContext/good_test_data/energy/Energy_MISO_20230330_083040.csv"; then
...
if ! upload_check "buildContext/good_test_data/energy/Energy_MISO_20230330_113740.csv"; then
