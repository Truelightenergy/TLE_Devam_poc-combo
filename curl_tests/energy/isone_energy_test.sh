...
truncate_energy "isone"

# upload 1
if ! upload_check "/home/alee/Documents/truelight/poc-combo/buildContext/good_test_data/energy/Energy_ISONE_20230522_082540.csv"; then
...
if ! upload_check "/home/alee/Documents/truelight/poc-combo/buildContext/good_test_data/energy/Energy_ISONE_20230522_082541.csv"; then
